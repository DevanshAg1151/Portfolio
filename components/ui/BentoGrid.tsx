...
export const BentoGridItem = ({
  ...
  const leftLists = ["TypeScript", "AI", "ML"];
  const rightLists = ["Python", "Web Dev", "GraphQL"];
  ...
  // const handleCopy = () => {
  //   const text = "agarwaldeva11@gmail.com";
  ...
  const handleCopy = () => {
    ...
    link.click();
    setCopied(true); // You can update the state to show a download confirmation if needed
  };
